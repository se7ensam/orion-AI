...
download() {
    ...
    local CMD_ARGS=(
        "python" "-m" "services.cli.main" "download"
...
show_help() {
    ...
    echo "  download [YEAR1] [YEAR2] [SKIP]  Download SEC filings"
    ...
    echo "  $0 build"
    echo "  $0 download                    # Default: 2009-2010"
    echo "  $0 download 2020 2021          # Download 2020-2021"
    echo "  $0 download 2009 2010 false    # Re-download existing files"
    echo ""
